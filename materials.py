...
materials = [{'r': 1,   'g': 0,   'b': 0,   'process': '3dp'},  # 0 - 3D printing
             {'r': 0,   'g': 1,   'b': 0,   'process': '3dp'},  # 1 - 3D printing
             {'r': 0,   'g': 0,   'b': 1,   'process': '3dp'},  # 2 - 3D printing
             {'r': 0.5, 'g': 0.5, 'b': 0.5, 'process': 'ins'},  # 3 - inserted component
             {'r': 1,   'g': 1,   'b': 0,   'process': '3dp'}]  # 4 - 3D printing